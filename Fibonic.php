...
<body>
    <form id="editForm">
        ...
        <input type="email" id="email" name="email" placeholder="Enter Email" value="<?php echo $user['email']; ?>" readonly><br>
        <span id="email_error" class="error"></span><br>
...
// Update user info
$sql = "UPDATE user_register SET first_name='$first_name', last_name='$last_name', phone='$phone', dob='$dob', gender='$gender', languages='$languages' WHERE id='$id'";
